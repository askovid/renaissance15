		...
		attach: function(context, settings) { 
			...
			$window.scroll(function() {
				...
				var activeIndex = setMenuItemActive(offset);
					...
					//Snap the screen to the active section
					/*scrollStoppedTimer = setTimeout(function() {
						var itemArray=$("#primary li");
						var $activeSection = $(itemArray.eq(activeIndex).find("a").attr("href"));
						var yPosition = $activeSection.attr("data-y-pos");

						//if there is a next section check if it's close enough to snap it
						var deltaMin = 2200;                                           
						if(activeIndex>1 && activeIndex<nSections){
							var $nextSection=$(itemArray.eq(activeIndex+1).find("a").attr("href"));                                                
							if($nextSection.attr("data-y-pos")-offset<deltaMin){
								yPosition = $nextSection.attr("data-y-pos");
							}
						}else if(offset<300){
							//special snap if on top of the page
							yPosition=0;
						}
    			...
    			// google map
    			/*var mapOptions = {
    				center: new google.maps.LatLng(46.974396, 7.442522),
    				zoom: 8,
			...
			$("#primary li a").click(function() {
    			...
    			$(".showmap").click(function() {
    				$.fancybox.open($("#map"), {
    					...
    					wrapCSS: "map-fancy",
    					beforeLoad: function() {
    						$(".map-container").html('<iframe width="1170" height="400" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0" src="https://docs.google.com/a/dce.edu/forms/d/1wEWMi0h8HDosbosI5GNK8XRmqt9kltF2MEY7jfgBmgc/viewform"></iframe>');
    					}
    				});
    				return false;
    			});
    			...
    			$(".showpop").click(function() {
    				$.fancybox.open($("#map"), {
    					...
    					wrapCSS: "map-fancy",
    					beforeLoad: function() {
    						$(".map-container").html('<iframe width="1170" height="400" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0" src="rules/tech.pdf"></iframe>');
    					}
    				});
    				return false;
    			});
    			...
    			$(".showspon").click(function() {
    				$.fancybox.open($("#map"), {
    					...
    					wrapCSS: "map-fancy",
    					beforeLoad: function() {
    						$(".map-container").html('<iframe width="1170" height="400" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0" src="sponsor.html"></iframe>');
    					}
    				});
    				return false;
    			});
